...
document.addEventListener('keydown', e => game.setKey(e.key))
document.addEventListener('keyup', e => game.unsetKey(e.key))
...
function gameFrame(){
  ...
  topCanvas.updateCanvas(state)
  sideCanvas.updateCanvas(state)
  ...
  if(state.state === 'PAUSED'){
    ...
    setTimeout(() => {
      ...
      game.setGamestate(game.GAME_STATES.AIMING)
